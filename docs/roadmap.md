...
## [v0.3.0] - Intelligence & Routing (In Progress)
...
## [v0.5.0] - Verification & Reliability
...
## [v0.6.0] - Agent Workflows
* ▢ **Specialist Pipelines:** Chain queries through Planner -> Specialist -> Reviewer.
* ▢ **Planner:** Decompose prompt into sequential sub-tasks.
* ▢ **Reviewer:** Perform error, performance, and code quality audits.
* ▢ **Workflow DAG:** Run dependent tasks in a directed acyclic graph.
